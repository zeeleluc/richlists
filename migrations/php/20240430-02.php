...
class Migration
{
    public function run()
    {
        ...
        $user = $user->fromArray([
            ...
            'project_name' => 'RipplPunks',
            'project_slug' => 'ripplepunks',
    ...
    {
        $user = (new \App\Query\UserQuery())->getUserByEmail(env('TEMP_EMAIL_CLIENT_3'));
    ...
    {
        $user = (new \App\Query\UserQuery())->getUserByEmail(env('TEMP_EMAIL_CLIENT_2'));
